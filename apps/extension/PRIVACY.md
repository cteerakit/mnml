...
*This document is provided for the Chrome Web Store and users of mnml. Host it at a public HTTPS URL (for example GitHub Pages) and paste that URL into the Chrome Web Store “Privacy policy” field.*
